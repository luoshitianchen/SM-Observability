...
DISPLAY_NAME = "SM Observability"
DESCRIPTION = "企业监控运维平台：健康检测、SLO、告警、延迟与错误率"
...
ITEMS: list[dict[str, object]] = [
    {"id": "demo-1", "name": "核心能力基线", "owner": "SRE团队", "priority": "P1", "status": "active", "created_at": datetime.now(UTC).isoformat()},
